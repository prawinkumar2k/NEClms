...
export function Results() {
  ...
  const GRADE_C = (g) => g?.startsWith("A") ? "text-success" : g?.startsWith("B") ? "text-blue-500" : "text-warning";
          ...
          {isLoading ? (
            ...
            <DataTableWrapper
              columns={[
                ...
                { key: "grade", header: "Grade", render: (r) => <span className={`font-black italic ${GRADE_C(r.grade)}`}>{r.grade}</span> },
                { key: "status", header: "Status", render: (r) => (
