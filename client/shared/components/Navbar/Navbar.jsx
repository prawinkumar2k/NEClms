          ...
          <div className="space-y-3 mt-2">
            ...
            {data.screenshot && (
              <div className="aspect-video rounded-xl overflow-hidden border border-white/10 shadow-2xl">
                <img src={data.screenshot} alt="Evidence" className="w-full h-full object-contain bg-black" />
              </div>
            )}
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="relative">
          <button onClick={() => { setProfileOpen(o => !o); setNotifOpen(false); }}
            ...
            <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-white text-xs font-black shadow-xl ring-1 ring-white/10 ${rc.badge}`}>
