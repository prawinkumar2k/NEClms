...
const StudentPlayground = lazy(() => import("@/modules/student/pages/CodingPlayground"));
...
export function PrivateRoutes() {
  return (
    <Routes>
      ...
      <Route path="/student/playground" element={<ProtectedRoute allowedRoles="student"><S><StudentPlayground /></S></ProtectedRoute>} />
